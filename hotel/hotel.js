...
function coste_avion(ciudad) {
    switch(ciudad) {
        case "medellin": return 400000;
        case "cartagena": return 800000;
        case "bogota": return 300000;
        case "armenia": return 600000;
        default: return 0; // Para manejar casos no especificados
    }
}
